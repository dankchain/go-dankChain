...
import (
	...
	"github.com/dankChain/go-dankChain/cmd/utils"
	...
	"github.com/dankChain/go-dankChain/ethclient"
...
var (
	...
	danktestFlag  = flag.Bool("danktest", false, "Initializes the faucet with DankChain danktest network config")
	danknetFlag  = flag.Bool("danknet", false, "Initializes the faucet with DankChain danknet network config")
...
func (f *faucet) apiHandler(w http.ResponseWriter, r *http.Request) {
	...
	for {
		...
		default:
			//lint:ignore ST1005 This error is to be displayed in the browser
			err = errors.New("Something funky happened, please open an issue at https://github.com/dankChain/go-dankChain/issues")
		}
		if err != nil {
			if err = sendError(wsconn, err); err != nil {
