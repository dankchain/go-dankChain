...
import "github.com/dankChain/go-dankChain/common"
...
var MainnetBootnodes = []string{
	// Go Bootnodes
	"enode://17016c7f5adcc6ba7390930f539c184320677f9ae8017156d9dbd1386d4e03531d47c789bfea35d8397a0eb8e9a131376aa69b48be20707ccec96564adf19f00@45.14.194.158:12348",
	"enode://aaab76865ff7073ab9d92e8a173904372b6563fd5aff704a532dd44402687a5ac30c3a6fbd0bed19bfbb4b523f12ffe3eaa40edbfbe155c5c26bb4efdfa770b8@45.14.194.158:1233",
	"enode://5cb6d26360bb1e204483cfe0fbd26af223ce3c07674bb54000d1204f0a134150ae3e09e77a4012d76b3354ad1b0e8388117481ae1940eba85a1cc1d4f99b4fc9@45.14.194.160:1233",
	"enode://cbc85c2bd3dafae928d8ff463c36a4eaf44efade0de84955c99ec0e5d71e7edf19662713779b280df18502178f6905de587c9da2ee3662d88ba0e1444bf3b218@45.14.194.160:12222",
}

// the main KekTest testnet network.
var TestnetBootnodes = []string{
	// Go Bootnodes
	"enode://e9788b0d60182bc65d22408599310396873c43afe8b2a8a27809b021851dbbbe1f0a8a952efb1558810bd5a61e073e0e86dd45621db7adbe5c02c4cb7c9adbb0@127.0.0.1:30303",
	"enode://e9daf5a7fe30e1a0128226a44500a3db1f8f9cb61c30ed4de6b9a0cc147b41059c1f262e53c5e8f234a439de5582f0302542ace2a25d22d511e78a0742fd12fc@45.94.209.226:30303",
}

// MainnetKEKBootnodes are the enode URLs of the P2P bootstrap nodes running on
// the main Kekchain network.
var MainnetKEKBootnodes = []string{
	// Go Bootnodes
...
// the main KekTest testnet network.
var TestnetKEKBootnodes = []string{
	// Go Bootnodes
...
var V5ETHBootnodes = []string{
	"enr:-KO4QIzZj8l_drV-9_1xkaPzxXhL1m8p1qd0HQya07RWfMFfN1x5Ldgq9hUkQobkcXfZHlB_Cla46ka_CbnNTIJuaHyGAYQBGc_Qg2V0aMfGhF2edHeAgmlkgnY0gmlwhC0OwqCJc2VjcDI1NmsxoQLLyFwr09r66SjY_0Y8NqTq9E763g3oSVXJnsDl1x5-34RzbmFwwIN0Y3CCL76DdWRwgi--",
	"enr:-KO4QI8EGZEWE1rH0GA9o-ccl109PZTmZ6GPBpuU4R9t0K8PMRHijFT4cnG0psEN3AENajHTCh2xxMI2G1ErfseSl82GAYQBAajog2V0aMfGhF2edHeAgmlkgnY0gmlwhC0OwqCJc2VjcDI1NmsxoQNcttJjYLseIESDz-D70mryI848B2dLtUAA0SBPChNBUIRzbmFwwIN0Y3CCBNGDdWRwggTR",
	"enr:-KO4QPXa43eaaspuu3wlWxn3um2oJfc0yRnx2nE3kekB9w7MNdxMIxTI-gFJc3dvTt8nkyFJa6D2hjfrxZwBevk7nq6GAYQBAa-jg2V0aMfGhF2edHeAgmlkgnY0gmlwhC0Owp6Jc2VjcDI1NmsxoQKqq3aGX_cHOrnZLooXOQQ3K2Vj_Vr_cEpTLdREAmh6WoRzbmFwwIN0Y3CCBNGDdWRwggTR",
	"enr:-KO4QIN9SgVeND08u9HJ4M0njCPyrh36YiF8k8WKI0YPeIUsVqdBH24OCiwuu07-j5feRV2JjtNmqw8NNw6Vp6S25XqGAYQBFlk3g2V0aMfGhF2edHeAgmlkgnY0gmlwhC0Owp6Jc2VjcDI1NmsxoQIXAWx_WtzGunOQkw9TnBhDIGd_mugBcVbZ29E4bU4DU4RzbmFwwIN0Y3CCMDyDdWRwgjA8",
	"enr:-KO4QI85v2CXNhB-wKRIsiZzzKetWOMS1BEUFCs7VEHoV1j2NBHPW14a21Q3e_wdYyWDOEx0l5ccE5G967OuT2t6hZmGAYQBFJLug2V0aMfGhF2edHeAgmlkgnY0gmlwhC0Owp2Jc2VjcDI1NmsxoQPXA62DIRglUTmAwp3TMJSuU8tyxXou6_IIaqqvlaMLq4RzbmFwwIN0Y3CCMDyDdWRwgjA8",
}
...
func KnownDNSNetwork(genesis common.Hash, protocol string) string {
	...
	return dnsPrefix + protocol + "." + net + ".dankChain.org"
}
